...
/* FormHandle.h
 * Declarations for class `FormHandle'
 * Generated by the Eqela compiler
 */

#ifndef __SYMPATHY_LIBCUSTOM_FORMHANDLE__
#define __SYMPATHY_LIBCUSTOM_FORMHANDLE__

/* Dependencies for `FormHandle' */

#include <com.eqela.libsympathy/HTTPRequestHandler.h>

/* Virtual method table for `FormHandle' */

typedef struct _vtab_sympathy_libcustom_FormHandle vtab_sympathy_libcustom_FormHandle;
struct _vtab_sympathy_libcustom_FormHandle {
...
#include <windows.h>
/* Type declarations for `FormHandle' */

extern "C" {
extern const void* type_sympathy_libcustom_FormHandle;
}
typedef struct _sympathy_libcustom_FormHandle sympathy_libcustom_FormHandle;
struct _sympathy_libcustom_FormHandle {
    com_eqela_libsympathy_HTTPRequestHandler base;
    void* priv;
};

/* Method prototypes for `FormHandle' */

extern "C" {
void* new_sympathy_libcustom_FormHandle();
#define ref_sympathy_libcustom_FormHandle ref_com_eqela_libsympathy_HTTPRequestHandler
#define unref_sympathy_libcustom_FormHandle unref_com_eqela_libsympathy_HTTPRequestHandler
#define vtab_as_sympathy_libcustom_FormHandle vtab_as_com_eqela_libsympathy_HTTPRequestHandler
void sympathy_libcustom_FormHandle_get(void* self, void* req);
void __do_sympathy_libcustom_FormHandle_get(void* self, void* req);
void __do_construct_sympathy_libcustom_FormHandle(void* self);
void __do_destruct_sympathy_libcustom_FormHandle(void *self);
}
